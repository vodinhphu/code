 ...
 */
namespace CustomMenu\CustomLink\Block\Html;
...
// echo "Hello worlddddddddddddddddddddddddddddddddddddddddddddddddddddd";
/**
    ...
    protected function _getHtml(
        ...
        foreach ($children as $child) {
            ...
            foreach($categories as $category){
                ...
                if($id == $child->getId()){        
                    if ($category->getData('ml_new_attribute') != ''){
                        $url = $category->getData('ml_new_attribute');
                    }
                    else{
                        $url = $child->getUrl();
                    }
            ...
            $html .= '<a href="' . $url . '" ' . $outermostClassCode . '><span>' . $this->escapeHtml(
                $child->getName()
