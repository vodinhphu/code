<?php
namespace Team2\OrderComment\Test\Unit\Model;
...
{
    /**
     * @var \Team2\OrderComment\Model\GuestOrderCommentManagement
     */
    ...
    protected function setUp()
    {
        ...
        $this->orderCommentManagementMock = $this->getMock(
            'Team2\OrderComment\Model\OrderCommentManagement',
            [],
            [],
            '',
            false
        ...
        $this->testObject = $objectManager->getObject(
            'Team2\OrderComment\Model\GuestOrderCommentManagement',
            [
    ...
    public function testSaveComment()
    {
        ...
        $orderCommentMock = $this->getMockBuilder('\Team2\OrderComment\Model\Data\OrderComment')
