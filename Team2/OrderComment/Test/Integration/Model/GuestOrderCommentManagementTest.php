<?php
namespace Team2\OrderComment\Test\Integration\Model;
 ...
 * @package Team2\OrderComment\Test\Integration\Model
 *
...
class GuestOrderCommentManagementTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGuestSaveOrderComment()
    {
        ...
        $model = $objectManager->create('\Team2\OrderComment\Api\GuestOrderCommentManagementInterface');

        $data = $objectManager->create('\Team2\OrderComment\Api\Data\OrderCommentInterface');
