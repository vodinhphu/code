<?php
namespace Team2BestSeller\BestsellersProducts\Block\Widget;
...
{
    /**
     * @var \Team2BestSeller\BestsellersProducts\Model\ResourceModel\Product\CollectionFactory
     */
     ...
     * @var string
     */
    protected $_template = 'Team2BestSeller_BestsellersProducts::widget/bestsellers-products.phtml';

    /**
     * NewWidget constructor.
     *
     * @param \Magento\Catalog\Block\Product\Context $context
     * @param \Team2BestSeller\BestsellersProducts\Model\ResourceModel\Product\CollectionFactory $productCollectionFactory
    ...
    public function __construct(
        ...
        \Team2BestSeller\BestsellersProducts\Model\ResourceModel\Product\CollectionFactory $productCollectionFactory,
    ...
    /**
     * @return \Team2BestSeller\BestsellersProducts\Model\ResourceModel\Product\Collection
     */
    ...
    public function getNameDisplay()
    {
        ...
        if (!$link) {
            $link = 'http://team2.local/team2/product/onepage';
        }
        return $link;
    }
}
