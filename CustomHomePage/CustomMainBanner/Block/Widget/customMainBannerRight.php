<?php
namespace CustomHomePage\CustomMainBanner\Block\Widget;
 ...
 */
class customMainBannerRight extends Template implements BlockInterface
{
    /**
     * @var Factory
     */
    protected $_template = "widget/customMainBannerRight.phtml";
